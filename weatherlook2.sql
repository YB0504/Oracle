...
CREATE TABLE REVIEW (
	...
	READ_COUNT VARCHAR2(50) NOT NULL, /* 조회수 */
	REG_DATE DATE NOT NULL, /* 작성일 */
	CONTENT VARCHAR2(1000) NOT NULL, /* 내용 */
	ITEM_TYPE VARCHAR2(20), /* 의상분류 */
	TYPE_ID NUMBER, /* 게시판타입ID */
	NICK VARCHAR2(30) /* 닉네임 */
);
...
CREATE TABLE COMMUNITY_REPLY (
	RE_ID NUMBER NOT NULL, /* 댓글ID */
	RE_CONTENT VARCHAR2(100) NOT NULL, /* 댓글내용 */
	RE_REF NUMBER NOT NULL, /* ref */
	RE_LEVEL NUMBER NOT NULL, /* 댓글 깊이 */
	RE_STEP NUMBER NOT NULL, /* 댓글출력순서 */
	RE_REGDATE DATE NOT NULL, /* 작성일 */
	NICK VARCHAR2(30), /* 닉네임 */
	POST_ID NUMBER /* 게시글ID */
);
...
ALTER TABLE COMM_REPORT
	ADD
		CONSTRAINT PK_COMM_REPORT
		PRIMARY KEY (
			REPORT_ID
		);
...
ALTER TABLE REVIEW
	ADD
		CONSTRAINT FK_BOARD_TYPE_TO_REVIEW
		FOREIGN KEY (
			TYPE_ID
		)
...
ALTER TABLE DAILY
	ADD
		CONSTRAINT FK_BOARD_TYPE_TO_DAILY
		FOREIGN KEY (
			TYPE_ID
		)
		REFERENCES BOARD_TYPE (
...
ALTER TABLE COMMUNITY
	ADD
		CONSTRAINT FK_BOARD_TYPE_TO_COMMUNITY
		FOREIGN KEY (
			TYPE_ID
		)
		REFERENCES BOARD_TYPE (
...
ALTER TABLE SCRAP
	ADD
		CONSTRAINT FK_BOARD_TYPE_TO_SCRAP
		FOREIGN KEY (
			TYPE_ID
		)
		REFERENCES BOARD_TYPE (
...
ALTER TABLE LIKES
	ADD
		CONSTRAINT FK_BOARD_TYPE_TO_LIKES
		FOREIGN KEY (
			TYPE_ID
		)
		REFERENCES BOARD_TYPE (
...
ALTER TABLE COMM_REPORT
	ADD
		CONSTRAINT FK_COMMUNITY_TO_COMM_REPORT
		FOREIGN KEY (
			POST_ID
		)
		REFERENCES COMMUNITY (
