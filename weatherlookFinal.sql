...
ALTER TABLE COMMUNITY_REPLY
	ADD
		CONSTRAINT FK_COMM_TO_COMM_REPLY
		FOREIGN KEY (
			POST_ID
		)
...
ALTER TABLE COMMUNITY_REPORT
	ADD
		CONSTRAINT FK_COMM_TO_COMM_REPORT
		FOREIGN KEY (
			POST_ID
		)
		REFERENCES COMMUNITY (
...
ALTER TABLE COMMUNITY_SCRAP
	ADD
		CONSTRAINT FK_COMM_TO_COMM_SCRAP
		FOREIGN KEY (
			POST_ID
		)
		REFERENCES COMMUNITY (
...
CREATE SEQUENCE DAILY_FILE_SEQ
START WITH 1
INCREMENT by 1;
...
CREATE SEQUENCE DAILY_LIKE_SEQ
START WITH 1
INCREMENT by 1;
...
CREATE SEQUENCE COMMUNITY_LIKE_SEQ
START WITH 1
INCREMENT by 1;

CREATE SEQUENCE DAILY_SCRAP_SEQ
START WITH 1
INCREMENT by 1;

CREATE SEQUENCE REVIEW_SCRAP_SEQ
START WITH 1
INCREMENT by 1;

CREATE SEQUENCE COMMUNITY_SCRAP_SEQ
START WITH 1
INCREMENT by 1;
